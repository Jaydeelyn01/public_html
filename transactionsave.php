...
if($_GET["action"]=='adds') {
  ...
  $query3 = "INSERT INTO tbltransacdetail(transac_code,date,customer_id,totalprice,status,add_date, remarks)VALUES('".$tat."','".$date."','".$_SESSION['cid']."','".$_SESSION['mm']."','Pending','".$del."', 'N/A' )";
